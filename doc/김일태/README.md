...
| UI 구조 | 요구사항 ID           | 기능명              | 기능 상세 설명                                                                                                                                             | 우선 순위 |
| ------- | --------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| WEB     | Signup_001            | 학생 회원가입       | 학교, 학과, 반, 학번, 이름, 전화번호, 비밀번호를 입력하고 교사 이메일 인증을 통해 회원가입을 할 수 있습니다.                                               | 0순위     |
| WEB     | Signup_002            | 교사 회원가입       | 학교, 학과, 반, 학번, 이름, 전화번호, 비밀번호를 입력하고 교사 이메일 인증을 통해 회원가입을 할 수 있습니다.                                               | 1순위     |
| WEB     | Login_001             | 유저 로그인         | 학생과 교사는 자신의 전화번호와 비밀번호로 로그인 할 수 있으며 로그인이 완료되면 교사와 학생 정보 보기가 가능합니다.                                       | 0순위     |
| WEB     | Logout_001            | 유저 로그아웃       | 학생과 교사는 상단 메뉴를 통해 로그아웃할 수 있습니다.                                                                                                     | 0순위     |
| WEB     | Textbook_001          | 교과서 목록 확인    | 학생은 교과서 목록에서 자신의 교과서 목록을 확인할 수 있습니다.                                                                                            | 1순위     |
| WEB     | Textbook_002          | 교과서 보기         | 학생은 교과서를 볼 수 있으며 조회수가 올라갑니다. 학습경과 시간이 카운팅되고 학습종료 시 시간이 저장됩니다.                                                | 0순위     |
| WEB     | WordInfo_001          | 학습 단어 표시      | 교과서에 등장한 단어를 포함한 학습 단어들이 조회됩니다.                                                                                                    | 2순위     |
| WEB     | WordInfo_002          | 단어 정보 제공      | 교과서에 있는 학습 단어에 대해 용어 설명이 제공됩니다. 학생은 사전을 통하여 이 단어의 뜻을 볼 수 있습니다.                                                 | 1순위     |
| WEB     | ServiceNavigation_001 | 교과서 보기 이동    | 상단 메뉴를 통해 교과서 보기 페이지로 이동할 수 있습니다.                                                                                                  | 0순위     |
| WEB     | ServiceNavigation_002 | 문제 풀기 이동      | 상단 메뉴를 통해 학습문제 푸는 페이지로 이동할 수 있습니다.                                                                                                | 0순위     |
| WEB     | ServiceNavigation_003 | 내 단어장 이동      | 상단 메뉴를 통해 나의 단어장 페이지로 이동할 수 있습니다.                                                                                                  | 1순위     |
| WEB     | ServiceNavigation_004 | 우리 반 페이지 이동 | 상단 메뉴를 통해 교사는 우리 반 페이지로 이동할 수 있습니다.                                                                                               | 1순위     |
| WEB     | WordTest_001          | 빈칸 문제 풀기      | 학생은 단어를 입력하여 빈칸 문제를 해결하는 문제를 풀 수 있으며 답안 제출 후 바로 결과를 확인할 수 있습니다. 틀린 문제는 다시 풀 수 있습니다.              | 1순위     |
| WEB     | WordTest_002          | 자동 문제 풀기      | 학생은 단어에 대해 자동 문제 풀이 방향으로 그 단어의 뜻을 고를 수 있습니다. 틀린 답안을 고르게 되면 마지막 답안을 제출할 때까지 정답을 선택할 수 있습니다. | 0순위     |
| WEB     | MyWord_001            | 내 단어장 확인      | 학생은 내 단어장에 저장된 단어의 뜻, 예문, 용례 지문을 확인할 수 있으며 용어가 자주 나오거나 나와야 할 단어장이 추천됩니다.                                | 2순위     |
| WEB     | Textbook_004          | 교과서 등록         | 교사는 우리 반 페이지에서 학생들이 학습할 교과서를 등록할 수 있습니다.                                                                                     | 1순위     |
| WEB     | TestResult_001        | 우리 반 문제 현황   | 교사는 우리 반 페이지에서 학생들의 문제 풀기 현황을 확인할 수 있습니다.                                                                                    | 1순위     |
| Alarm   | TestAlarm_001         | 문제 풀기 알림      | 문제가 제출되면 학생들에게 알림이 전달되며 상단 메뉴에서 모양 아이콘을 통해 확인할 수 있습니다.                                                            | 3순위     |

# 서비스 정리

- 관리자가 계정을 생성하고 학년을 부여
- 학생은 교과서 목록 및 해당 교과서 보기
- 교과서 핵심 단어가 색인되며 뜻을 단어장에 표시
- 단어장은 일정 기준으로 나눠지고 이 기준에 따른 문제 풀이에 접근
- 원하는 단어 또는 틀린 문제를 내 단어장으로 저장
